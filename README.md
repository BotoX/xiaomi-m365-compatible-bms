...
### Serial programming / Updating
You can flash a bootloader to the ATMega with the following command: `avrdude -patmega328p -cstk500v2 -P/dev/ttyUSB0 -U flash:w:ATmegaBOOT_168_atmega328_pro_8MHz.hex`  
This allows you to program the BMS through serial UART, you have to short the GND and RESET pin before/after hitting the upload button however.
